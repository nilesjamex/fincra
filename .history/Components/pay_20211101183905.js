...

           {
            ...
            value={to} placeholder="to" />
                ...
                case 2:
                    ...
                    <h6 onClick={(e) => setIban(false)} style={{cursor: "pointer", margin: "0.6rem", color: `${iban ? "#8B8F96" : "#4305EB"}`}}>Inside Europe</h6>
                    <h6 onClick={(e) => setIban(true)} style={{cursor: "pointer", margin: "0.6rem", color: `${iban ? "#4305EB" : "#8B8F96"}`}}>Outside Europe</h6>
                    </div>
                {
                    !iban && <div>
                    <div className={styles.payinfo}>
